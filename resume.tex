...
\newenvironment{list2}{
  \begin{list}{$\bullet$}{%
      ...
      %\setlength{\parsep}{0in} \setlength{\parskip}{0in}
      %\setlength{\topsep}{0.1cm} \setlength{\partopsep}{0in}
...
\name{David Y. Hu}
\address{(519) 729-5861\hspace{1cm}dh@david-hu.com}
...
\section{Skills}
        ...
        \begin{list2}
            \item C++: 5 years of experience through work, personal projects, contests, robotics, and school
            \item JavaScript: Optimizations and browser bug work-arounds for Google Docs
            \item Moderate experience in Python, C, C\#, Qt, Django, Google Closure Tools
            \item Working experience in Bash scripting, YAML, \LaTeX, Scheme, ASP.NET
            \item Experienced with the Linux command line; Ubuntu; Mac OS X; Windows
            \item Proficient with Vim and Git; worked with GNU Make, Perforce, SVN, Visual Studio
        \end{list2}
        {\bf General}
        \begin{list2}
            \item Regularly competes in programming contests, including ACM, Google AI contest, CCC, Project Euler, USACO
            \item Django and MySQL backend for various web projects
            ...
            \item High school: FIRST Robotics controller, Xbox 360 video game, tournament scheduler
            \item Interests include machine learning, compilers, and functional programming
        \end{list2}
